...
<html>
  ...
  <body>
    ...
    <?php
      $dataRecords = file('data/roster.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    ...
    <table style="border:1px solid black; border-collapse:collapse;">
      <tr>
        ...
        <th style="vertical-align:top; border:1px solid black; background: lightgreen;">  Zip code </th>
      </tr>
      <?php
